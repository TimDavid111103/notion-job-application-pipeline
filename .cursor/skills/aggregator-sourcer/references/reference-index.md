...
**Hard rule:** `npm run cleanup:data` at step 5 and step 9 — wipe all temp `data/` files;
keep only `sourced-jobs.md` + `.gitkeep`.
...
Every path under `.cursor/skills/aggregator-sourcer/`:
