...
Single source of truth for daily Jack clean-out. Runner: `npx tsx scripts/sources/jack-empty.ts`.
...
deduped by scratch `jobKey` ([scratch-data-formats.md](scratch-data-formats.md)).
