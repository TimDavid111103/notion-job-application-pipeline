...
Versioned JSON envelopes under `data/`. Schema version: `1`. Builders: `scripts/lib/fill-artifacts.ts`.

## Permanent vs temporary

| File | Lifecycle |
|------|-----------|
| `references/personal-information.md` | Permanent (skill folder) |
| `references/projects.md` | Permanent |
| `references/answers.md` | Permanent |
