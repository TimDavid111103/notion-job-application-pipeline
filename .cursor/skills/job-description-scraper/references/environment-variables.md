...
|---|---|---|---|
| `HEADED` | unset (headless) | `1` = visible browser (debug) | `scrape-descriptions.ts` via `browser.ts` |
...
| Constant | Path |
|---|---|
| `SCRAPE_QUEUE_FILE` | `data/notion-scrape-queue.json` |
| `SCRAPE_RESULTS_FILE` | `data/scrape-results.json` |
| `JOBS_NEEDING_DESCRIPTIONS_FILE` | `data/jobs-needing-descriptions.json` |
