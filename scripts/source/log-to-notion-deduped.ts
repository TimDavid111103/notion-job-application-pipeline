...
import { NOTION_PAYLOADS_FILE, NOTION_SNAPSHOT_FILE, ensureParentDir } from "../lib/paths.js";
import { dedupeAgainstNotion, parseNotionQueryResults, prepareNotionPayloads } from "../lib/notion/index.js";
import { SCRATCH_FILE, filterJobsByDateSourced, jobKey, parseScratchFile, todayIso } from "../lib/job/scratch.js";
...
async function main(): Promise<void> {
  ...
  await ensureParentDir(NOTION_PAYLOADS_FILE);
