...
import {
  ...
  sleep,
} from "../lib/scrape/job-description.js";
import { JOBS_NEEDING_DESCRIPTIONS_FILE, SCRAPE_QUEUE_FILE, SCRAPE_RESULTS_FILE, ensureParentDir } from "../lib/paths.js";
import {
...
async function main(): Promise<void> {
  ...
  if (toProcess.length === 0) {
    await ensureParentDir(SCRAPE_RESULTS_FILE);
    await writeFile(
      SCRAPE_RESULTS_FILE,
